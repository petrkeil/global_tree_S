...
PLT$Tree_dens <- (PLT$N + 1) / PLT$Area_km # create tree density (note the x+1 step!!)
...
png(file="../Figures/Fig_S6_PCA.png", width=2000, height=1000, res=180)
